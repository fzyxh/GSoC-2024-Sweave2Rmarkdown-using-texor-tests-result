...
G = P{ "Doc",
  ...
  List = V"BulletList"
       + V"OrderedList" ;
  BulletList = P(ListItem(1,'*')^1);
  OrderedList = P(ListItem(1,'#')^1);
  ...
  TableHeader = P(V"HeaderCell"^1)
              * cellsep^-1
              * spacechar^0
              * newline ;
  TableRow   = P(V"BodyCell"^1)
             * cellsep^-1
             * spacechar^0
             * newline ;
  HeaderCell = cellsep
  ...
  URL = P"http"
      * P"s"^-1
      * P":"
      * P(1 - (whitespacechar + (S",.?!:;\"'" * #whitespacechar)))^1
      / function(url)
